namespace GameFoundation.GameFoundationUtilities.LoadHelper
{
    ...
    public class LoadImageHelper : ILoadLocalHelper<Sprite>, ILoadFromUrlHelper<Sprite>
    {
        ...
        public async UniTask<Sprite> LoadLocal(string key)
        {
            try
            {
        ...
        public async UniTask<Sprite> LoadFromUrl(string url)
        {
