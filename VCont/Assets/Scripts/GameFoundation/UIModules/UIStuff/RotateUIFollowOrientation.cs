namespace GameFoundation.Scripts.UIModule.Utilities.UIStuff
{
    ...
    public class RotateUIFollowOrientation : MonoBehaviour
    {
        ...
        private void Start() { this.detectRotateOrientation.state.Subscribe(this.OnChangeOrientation); }
        ...
        [Button("RotateScreen")]
        public void RotateScreen(DeviceOrientation value) { this.detectRotateOrientation.state.Value = value; }
    }
}