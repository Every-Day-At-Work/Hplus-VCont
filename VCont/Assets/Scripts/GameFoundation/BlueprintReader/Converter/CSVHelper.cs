namespace GameFoundation.BlueprintReader.Converter
{
    using System;
    ...
    public static class CsvHelper
    {
        ...
        public static string GetField(this CsvDataReader csvReader, string name, Type type)
        {
            try
            {
            ...
            {
                Debug.LogError($"GetField -{type.Name}-{name} :" + e);
