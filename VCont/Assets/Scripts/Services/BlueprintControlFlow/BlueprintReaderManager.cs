namespace BlueprintFlow.BlueprintControlFlow
{
    ...
    public class BlueprintReaderManager
    {
        ...
        public BlueprintReaderManager(ISignalBus signalBus, ILogService logService, IObjectResolver container, IHandleUserDataServices handleUserDataServices, BlueprintConfig blueprintConfig,
        ...
        private UniTask ReadAllBlueprint(Dictionary<string, string> listRawBlueprints)
        {
            ...
            {
                var blueprintInstance = (IGenericBlueprintReader)this.container.Resolve(blueprintType);
